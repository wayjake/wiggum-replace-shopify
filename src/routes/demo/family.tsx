...
export const Route = createFileRoute('/demo/family')({
  head: () => ({
    meta: [
      { title: 'Family Portal Demo | Enrollsy' },
      { name: 'description', content: 'See what parents experience with Enrollsy. Track applications, manage billing, and stay connected.' },
      { property: 'og:title', content: 'Family Portal Demo | Enrollsy' },
    ],
  }),
...
function FamilyDemo() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F5F2]">
      {/* Demo Banner */}
      <div className="bg-gradient-to-r from-[#1F2A44] to-[#2F5D50] text-white py-3 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/contact"
              className="bg-white text-[#1F2A44] px-4 py-1.5 rounded-md text-sm font-medium hover:bg-white/90"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="w-8 h-8 bg-[#2F5D50]/10 rounded-full flex items-center justify-center text-sm font-medium text-[#2F5D50]">
                MM
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div
              className={cn(
                ...
                showTour && currentStep === 1 && "ring-2 ring-[#2F5D50] ring-offset-2"
              )}
              id="children-section"
            >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-[#2F5D50] cursor-pointer hover:underline">
                  View all
                </span>
              </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              {mockPaymentPlans.active && (
                <div className="bg-[#2F5D50]/5 border border-[#2F5D50]/20 rounded-lg p-3 mb-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-[#2F5D50] font-medium">Payment Plan Active</span>
              ...
              {/* Pay Now Button */}
              <button className="w-full mt-4 bg-[#2F5D50] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#1F2A44] transition-colors">
                Make a Payment
              </button>
            </div>
      ...
      {tourCompleted && !showTour && (
        <div className="fixed bottom-6 right-6 bg-white rounded-xl shadow-lg border border-gray-200 p-6 max-w-sm animate-slide-up">
          <h3 className="font-semibold text-[#1F2A44] mb-2">Parents love this experience</h3>
          <p className="text-sm text-gray-600 mb-4">
            Give your families a portal they'll actually want to use. See Enrollsy in action with a personalized demo.
          </p>
